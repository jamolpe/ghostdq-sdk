...
by :class:`~ghostdq.metrics.engines.streaming.engine.StreamingCsvMetricsEngine` to compute the same metric
...
class StreamingState:
    """Mutable scan state for :class:`~ghostdq.metrics.engines.streaming.engine.StreamingCsvMetricsEngine`.
