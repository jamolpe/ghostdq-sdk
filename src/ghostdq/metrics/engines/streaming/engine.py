...
from ghostdq.metrics.engines.streaming.accumulators import StreamingState
...
class StreamingCsvMetricsEngine:
    ...
    Uses :class:`~ghostdq.metrics.engines.streaming.accumulators.StreamingState` instead of loading
